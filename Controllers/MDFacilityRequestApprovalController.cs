...
{
    public class MDFacilityRequestApprovalController : Controller
    {
        // GET: MDFacilityRequestApproval
        public ActionResult ApproveRequest(int? page)

        {
            MDFacilityRequestApprovalViewModel vm = new MDFacilityRequestApprovalViewModel();
            try
            {
        ...
        [HttpPost]
        public ActionResult ApproveRequest(MDFacilityRequestApprovalViewModel vm)
